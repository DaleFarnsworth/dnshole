...
func addDomains(w io.Writer, domains []string) {
	fmt.Fprintln(w, dnsholeMarkerLine+" Do not edit this line or following lines.")
	fmt.Fprintln(w, "# They are automatically generated by dnshole.")
	timeStr := time.Now().Format(" Monday 2006-01-02 15:04:05 MST")
	fmt.Fprintln(w, "# Generated"+timeStr)
	fmt.Fprintln(w, "")
